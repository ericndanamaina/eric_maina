...
/*code for encoding and decoding data

--With checksum to detect errors in addresses
--base58 is an encoding  standard used in encoding and decoding bitcoin addresses.

--used for representing sensitive information 
